...
from task_manager.utils import MsgSuccessMixin, DeleteRelatedMixin, UserEditAuthMixin
...
class UsersUpdateView(UserEditAuthMixin, MsgSuccessMixin, UpdateView):
    model = User
...
class UsersDeleteView(UserEditAuthMixin, DeleteRelatedMixin):
    model = User
